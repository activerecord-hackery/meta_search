...
Note: If you define your search method as class method, you should allow this method to
receive arguments, otherwise you will get a 'wrong number of arguments exception', for example:

  class class Company < ActiveRecord::Base
    def self.some_class_method(*args)
      # do smth.
    end

    search_methods :some_class_method
  end
