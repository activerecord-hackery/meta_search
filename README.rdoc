...
* _gte_ (aliases: _greater_than_or_equal_to_, _gteq_) - Greater than or equal to.
* _less_than_ (alias: _lt_) - Less than.
* _lte_ (aliases: _less_than_or_equal_to_, _lteq_) - Less than or equal to.
* _between_ (aliases: _btw_) - Between.
