module MetaSearch
  class Context
    ...
    def visit_MetaSearch_Nodes_Condition(object)
      object.apply_predicate if object.valid?
    end

    def visit_MetaSearch_Nodes_And(object)
    ...
    def visit_MetaSearch_Nodes_Sort(object)
      object.attr.send(object.dir) if object.valid?
    end

    def visit_MetaSearch_Nodes_Or(object)
      nodes = object.values.map {|o| accept(o)}.compact
      return nil unless nodes.size > 0
